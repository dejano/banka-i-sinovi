...
import gui.standard.form.components.exception.NegativeValueException;
import javax.swing.*;
...
public class DecimalTextField extends JTextField implements IValidationTextField {
    ...
    /**
     * @param columns           Duzina polja, kao kod JTextField-a
    ...
    private class MyDocument extends PlainDocument {
        ...
        public void remove(int offs, int len) throws BadLocationException {
            ...
            if (!ignoreEvents && !oldValue.equals(newValue))
                DecimalTextField.this.firePropertyChange(TEXT_PROPERTY, oldValue, newValue);
        }
    }
